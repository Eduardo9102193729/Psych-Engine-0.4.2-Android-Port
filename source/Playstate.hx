...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Que Lixo!', 0.2], //From 0% to 19%
		['Horrivel', 0.4], //From 20% to 39%
		['Ruim', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Bom', 0.7], //69%
		['Top', 0.8], //From 70% to 79%
		['Otimo', 0.9], //From 80% to 89%
		['Soda!', 1], //From 90% to 99%
	...
	override public function create()
	{
        ...
        var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,("Port by (Fakekris) "), 24);
